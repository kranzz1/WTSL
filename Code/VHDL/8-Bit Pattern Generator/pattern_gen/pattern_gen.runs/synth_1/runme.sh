...
HD_PWD='C:/Users/zkran/Documents/College/Lab/8-Bit Pattern Generator/pattern_gen/pattern_gen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pattern_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pattern_gen.tcl
