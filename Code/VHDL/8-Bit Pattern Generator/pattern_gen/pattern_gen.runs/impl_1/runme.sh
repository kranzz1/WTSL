...
HD_PWD='C:/Users/zkran/Documents/College/Lab/8-Bit Pattern Generator/pattern_gen/pattern_gen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pattern_gen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pattern_gen.tcl -notrace
